...
class MemorySimulator:
    def __init__(self, page_size, num_tlb_entries, num_frames, replacement_policy, va_bits=32):
        ...
        self.clock_idx = 0                        # ponteiro circular para SecondChance
    ...
    def obter_frame_para_pagina(self, pagina: int):
        ...
        # precisa evictar
        if self.replacement_policy == 'LRU':
            vit_pagina, vit_frame = self.lru_escolhe_vitima()
        else:
            vit_pagina, vit_frame = self.sc_escolhe_vitima()
